...
pub struct CommittedSnapshot {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub custom_extension_params: Option<CustomExtensionParams>,
    /// Optional startup memory manifest descriptor. Present only when the
    /// manifest was recorded and stored successfully; absent on older
    /// snapshots and on best-effort recording failures.
    #[serde(default, skip_serializing_if = "Option::is_none")]
